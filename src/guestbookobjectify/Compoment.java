...
public class Compoment {
	...
	public String textArea(String key, int index) {
		...
		String S = "<div class=\"form-group\">" + "\n"
				+ "<label class=\"col-md-4 control-label\" for=\"textarea\"></label>" + "\n"
				+ "<div class=\"col-md-4\">" + "\n"
				+ "<textarea class=\"form-control\" id=\"textarea\" name=\"textreponse" + index + "\">+" + key
				+ "</textarea>" + "\n" + " </div>" + "\n" + "</div>" + "\n";
		return S;
	}
	...
	public String WriteRadio(String key, int value, int index) {
		...
		String S = "<div class=\"form-group\">" + "\n"
				+ "<label class=\"col-md-4 control-label\" for=\"radios\"></label>" + "\n" + "<div class=\"col-md-4\">"
				+ "\n" + "<div class=\"radio\">" + "\n" + "<label for=\"radios-0\">" + "\n" + "<input name=\"radios"
				+ index + "\" id=\"radios-0\" value=\"" + key + "\" checked=\"checked\" type=\"radio\">" + "\n" + key
				+ "\n" + " </label>" + "\n" + "</div>" + "\n";
		return S;
	}
	...
	public String WritecheckBoxI(String Key, int value) {
		...
		String S = "<div class=\"form-group\">" + "\n"
				...
				+ "<div class=\"col-md-4\">" + "\n" + "<div class=\"checkbox\">" + "\n"
				+ "<label for=\"checkboxes-inline\">" + "\n" + "<input name=\"checkboxes\" id=\"checkboxes-0\" value="
				+ v + " type=\"checkbox\">" + Key + "\n" + "</label>" + "\n" + "</div>" + "\n" + "</div>" + "\n"
				+ "</div>";
		return S;
	}
	...
	public String WritecheckBox(String Key, int value) {
		...
		String S = "<div class=\"form-group\">" + "\n"
				...
				+ "\n" + "<input name=\"checkboxes" + v + "\" id=\"checkboxes-0\" value=\"" + Key
				+ "\" type=\"checkbox\">" + Key + "\n" + "</label>" + "\n" + "</div>" + "\n" + "</div>" + "\n"
				+ "</div>";
		return S;
	}
	...
	public String WritecheckBox(String Key, int value, int index) {
		...
		String S = "<div class=\"form-group\">" + "\n"
				+ "<label class=\"col-md-4 control-label\" for=\"checkboxes\"></label>" + "\n"
				+ "<div class=\"col-md-4\">" + "\n" + "<div class=\"checkbox\">" + "\n" + "<label for=\"checkboxes-0\">"
				+ "\n" + "<input name=\"checkboxes" + index + "\" id=\"checkboxes-0\" value=\"" + Key
				+ "\" type=\"checkbox\">" + Key + "\n" + "</label>" + "\n" + "</div>" + "\n" + "</div>" + "\n"
				+ "</div>";
		return S;
	}
